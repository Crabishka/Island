...
/// Во время поиска в глубину мы помечаем все 1 этого острова как visited,
/// и при дальнейшем поиске островов, игнорируем их (так как они уже являются частью какого-то острова)
///
...
/// но мы также траним еще O(n*m) на восстановление таблицы
